...
void ihex_begin_read(struct ihex_state *ihex, cb_ihex_data_read_t cb_read, void *args);
...
void ihex_read_at_address(struct ihex_state *ihex,
                          ihex_address_t address,
                            cb_ihex_data_read_t cb_read, void *args);
...
void ihex_read_at_segment(struct ihex_state *ihex, ihex_segment_t segment, cb_ihex_data_read_t cb_read, void *args);
#endif
