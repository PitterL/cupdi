...
//#define NVM_FUSES_INFO(_nvm) (&(_nvm)->dev->mmap->fuse)
//#define NVM_FUSES(_nvm, _name) (NVM_FUSES_INFO(_nvm)->_name)
/*
    NVM object init
...
int nvm_read_flash_old(void *nvm_ptr, u16 address, u8 *data, int len)
{
    /*
        Reads from flash
    */
